...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.1.0/AiServiceKit.xcframework.zip",
            checksum: "6b0cd70b22d7181347debd6485fcc98bfe694c78d3046c7b8ee110cbbf77e250"
        )
    ]
)
