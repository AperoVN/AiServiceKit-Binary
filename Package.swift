...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.3.0/AiServiceKit.xcframework.zip",
            checksum: "ec31625be7141abfd64eb0d31acd795de08f58b7b123ef10c43f5e942be84573"
        )
    ]
)
