...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AiServiceKit",
            url: "https://github.com/AperoVN/AiServiceKit-Binary/releases/download/2.2.0/AiServiceKit.xcframework.zip",
            checksum: "eeb8063b57f66757416adacd7cf4b058148ad4928db2034612e8ca4ebde66bc6"
        )
    ]
)
